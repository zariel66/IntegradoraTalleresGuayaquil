...
@section("content")
	...
	<div class="row login-section">
		<div class="panel panel-default col-md-offset-4 col-md-4">
				<br>
				<img src="{{ URL::asset('imagenes/icons/404.png')}}" alt="imagen" class="center-block" style="width:230px;height:130px">
				...
				<div class="panel-body">
					<div class="alert alert-danger text-center">
					  <h4 style="margin:0px">
					  	...
					  	<strong>La página solicitada no ha sido encontrada</strong>
					  	<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
					  </h4>
					</div>
				</div>

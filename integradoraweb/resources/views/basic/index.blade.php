...
<div id="info-section-background"  class="container">
	<div class="panel panel-default col-md-offset-2 col-md-8">
		<div class="panel-body" id="cuerpopanel">
			...
			<div class="row">
				<video  class="center-block" width="640" height="480" controls autoplay="autoplay">
			...
			<div class="row">
				<div class="col-md-6">
					<article>
						...
						<p class="text-justify">Al usar nuestra aplicación puedes acceder de forma gratuita a información de talleres ubicados en Guayaquil cercanos a ti que ofrecen servicios de mantenimiento y reparación vehicular. Tan solo requieres un dispositivo con internet o gps y buscaremos por ti el taller que necesitas de acuerdo a la marca de tu vehículo. Los servicios ofrecidos por los talleres en nuestra plataforma son:</p>
						<br>
						<div class="col-md-4 col-md-offset-2">
							<ul class="text-center" style="list-style-type:disc;padding-left:0;">
							  <li>Carrocería</li>
			...
			<div class="row">
				<div class="col-md-6">
					<article>
						<h4><strong>¿Como acceder a nuestros servicios?</strong></h5>
